...
to setup
  ...
  ; coloring the four parts of the world
   if  graficos
    [
      let p1 0
      repeat 33
...
set ProbOfSuccesOf-tan2 100 - ProbOfSuccesOf-tan1

  set data csv:from-row file-read-line
set No-of-desactivating-tumor-cells-by-tan1 item 1 data
  set data csv:from-row file-read-line
set  ProbOfSuccesOf-tam1 item 1 data
set  ProbOfSuccesOf-tam2 100 - ProbOfSuccesOf-tam1
  set data csv:from-row file-read-line
